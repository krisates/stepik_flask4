...
departures_list = {"msk": "Москва", "spb": "Петербург", "nsk": "Новосибирск", "ekb": "Екатеринбург", "kazan": "Казань"}
...
@app.route('/data/')
def route_data():
  return render_template('data.html', title=title, subtitle=subtitle, description=description, departures=departures, list=tours)


@app.route('/tours/<int:tour_id>/')
def route_tours(tour_id):
  return render_template('tour.html', title=title, subtitle=subtitle, description=description, departures=departures, list=tours[tour_id])


@app.route('/data/tours/<int:tour_id>/')
def route_data_tours(tour_id):
  return render_template('datatour.html', title=title, subtitle=subtitle, description=description, departures=departures, list=tours[tour_id])


@app.route('/departures/<departure>/')
def route_departures(departure):
  return render_template('departure.html', title=title, subtitle=subtitle, description=description, departures=departures, departure=departure)


@app.route('/data/departures/<departure>/')
def route_data_departures(departure):
  ctours = {}
  for tour in tours:
    if (tours[tour]['departure'] == departure):
      ctours[tour] = tours[tour]
